...
const API_BASE = "http://165.227.126.29:8083/api/appointmentCreate";
...
handleSubmit() {
 ...
 axios
  ...
  componentWillMount() {
    axios.post(API_BASE).then(response => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Step>
              <StepLabel>
                Share your contact information with us and well send you a  reminder
              </StepLabel>
              <StepContent>
                <p>
                  <section>
